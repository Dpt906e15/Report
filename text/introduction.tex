...
After an analysis of the area, we will give a language comparison, done as an subjective evaluation through discussion by the authors. We will state the criteria evaluated in the comparison in \chapref{chap:criteria}. The comparative analysis itself will be provided in \chapref{chap:language_analysis}. A conclusion on the analysis will be given in \chapref{chap:conclusion}, which also gives a discussion on the matter and ideas for further works.
